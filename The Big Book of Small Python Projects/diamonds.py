...
def main():
    print('Diamonds, by Al S.')

    # Display diamonds of sizes 0 trough 6:
...
def displayFilledDiamond(size):
    #Display the top halt of the diamond:
    for i in range(size):
        print(' ' * (size - i - 1), end='') # Left side space
        print('/' * (i + 1), end='') # Left half of diamond;
        print('\\' * (i + 1)) # Right half of diamond.

    # Displau the bottomhalf of diamond:
    for i in range(size):
        print(' ' * i, end='') # Left side space
        print('\\' * (size - i), end='') #Lef side diamont
